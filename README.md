...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
  React JS solves problems like code efficiency and reusability. It allows developers to create complex programs with a powerful web of components. React is also smart enough to only update/re-render what needs to be (in the DOM), instead of the entire web page.

1. Describe component state.
  State controls the behavior of the component and most likely will change over time. Helps tell the component what to do.

1. Describe props.
  Props are data that is shared between React components and plays a big hand in what is rendered on the screen.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
  Side effects are/is code that run when you may not want it to. This can affect your web pages performance. You can use useEffect() to turn side effects from a bug to a feature.
